...
public class ModBlocks {
	...
	public static final FruitTreeBlock apple_fruit_tree = create("apple_fruit_tree", new FruitTreeBlock(Items.APPLE, Items.APPLE, ModBlocks.apple_fruit_tree, ModProperties.fruit_tree));
	public static final FruitTreeBlock orange_fruit_tree = create("orange_fruit_tree", new FruitTreeBlock(ModItems.orange, ModItems.rotten_orange, ModBlocks.orange_fruit_tree, ModProperties.fruit_tree));
	public static final FruitTreeBlock apricot_fruit_tree = create("apricot_fruit_tree", new FruitTreeBlock(ModItems.apricot, ModItems.rotten_apricot, ModBlocks.apricot_fruit_tree, ModProperties.fruit_tree));
