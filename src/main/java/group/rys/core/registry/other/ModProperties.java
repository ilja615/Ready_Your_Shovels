...
public class ModProperties {
	...
	public static final Block.Properties fruit_sapling = Block.Properties.create(Material.PLANTS).hardnessAndResistance(0.0F).sound(SoundType.PLANT).harvestLevel(0).tickRandomly();
