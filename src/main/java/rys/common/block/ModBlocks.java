...
public class ModBlocks {
	...
	public static final StairsBlockMod tough_dirt_stairs = null;
	public static final WallBlock tough_dirt_wall = null;
	public static final SlabBlock dirt_bricks_slab = null;
	public static final StairsBlockMod dirt_bricks_stairs = null;
	...
	public static void registerBlocks(RegistryEvent.Register<Block> event) {
		...
		registry.register(create("tough_dirt_stairs", new StairsBlockMod(tough_dirt.getDefaultState(), ModBlockProperties.tough_dirt)));
		...
		registry.register(create("dirt_bricks_stairs", new StairsBlockMod(dirt_bricks.getDefaultState(), ModBlockProperties.dirt_bricks)));
