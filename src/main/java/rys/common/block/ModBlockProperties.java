...
public class ModBlockProperties {
	...
	public static final Block.Properties dayroot = Block.Properties.create(Material.TALL_PLANTS).hardnessAndResistance(0.0F, 0.0F).sound(SoundType.PLANT).harvestLevel(0).doesNotBlockMovement().lightValue(15);
