...
public class ModBlockProperties {
	...
	public static final Block.Properties fruit_tree = Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0F, 2.0F).sound(SoundType.PLANT).harvestLevel(0).harvestTool(ToolType.AXE).doesNotBlockMovement().tickRandomly();
